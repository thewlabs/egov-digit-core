import { PrivateRoute, Card, BreadCrumb, HRIcon, EmployeeModuleCard, AttendanceIcon, Loader } from '@egovernments/digit-ui-react-components';
import React, { useState, useEffect } from 'react';
import { Switch, Link, useRouteMatch } from 'react-router-dom';
import { useTranslation } from 'react-i18next';
import { useQuery } from 'react-query';

const CustomBredcrumb = ({
  t
}) => {
  ...
  return /*#__PURE__*/React.createElement(BreadCrumb, {
    crumbs: [{
      ...
      path: `/${(_window2 = window) === null || _window2 === void 0 ? void 0 : _window2.contextPath}/employee`,
      content: t("Sample"),
      show: true
    }],
    spanStyle: {
...
const App = ({
  ...
  return /*#__PURE__*/React.createElement(Switch, null, /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(CustomBredcrumb, {
    t: t
  }), /*#__PURE__*/React.createElement(PrivateRoute, {
    path: `${path}/pageone`,
    component: () => /*#__PURE__*/React.createElement(Card, null, /*#__PURE__*/React.createElement("div", null, "Sample screen created in Mukta Customisation folder"))
  }))));
};

var Digit$1 = window.Digit || {};
const logoutV1 = async () => {
  let user = Digit$1.UserService.getUser();
  if (!user || !user.info || !user.access_token) return false;
  const {
    type
  } = user.info;
  const access_token = user === null || user === void 0 ? void 0 : user.access_token;
  const tenantId = type === "CITIZEN" ? Digit$1.ULBService.getStateId() : Digit$1.ULBService.getCurrentTenantId();
  ...
  const userType = Digit$1.UserService.getType();
  try {
    await fetch(`${window.location.origin}/user/v1/_logout?tenantId=${tenantId}`, requestOptions).then(response => response.json()).catch(error => console.log("error", error));
  } catch (e) {} finally {
...
const useEventDetails = (tenantId, filters, config = {}) => {
  return useQuery(['EVENT_DETAILS', tenantId, filters], () => Digit.EventsServices.EventDetails(tenantId, filters), {
    select: data => {
      var _data$eventDetails, _data$eventDetails2, _data$eventDetails3, _data$eventDetails4, _data$eventDetails5, _data$eventDetails6, _data$eventDetails7, _data$eventDetails8, _data$eventDetails9, _data$eventDetails10, _data$eventDetails11;
      const details = [{
        title: " ",
        asSectionHeader: true,
        values: [{
          title: "JAGAN",
          value: data === null || data === void 0 ? void 0 : data.tenantId
        }, {
          title: "EVENTS_NAME_LABEL",
          value: data === null || data === void 0 ? void 0 : data.name
        }, {
          title: "EVENTS_CATEGORY_LABEL",
          value: data === null || data === void 0 ? void 0 : data.eventCategory
        }, {
          title: "EVENTS_DESCRIPTION_LABEL",
          value: data === null || data === void 0 ? void 0 : data.description
        }, {
          title: "EVENTS_FROM_DATE_LABEL",
          value: format(new Date(data === null || data === void 0 ? void 0 : (_data$eventDetails = data.eventDetails) === null || _data$eventDetails === void 0 ? void 0 : _data$eventDetails.fromDate), 'dd/MM/yyyy')
        }, {
          title: "EVENTS_TO_DATE_LABEL",
          value: format(new Date(data === null || data === void 0 ? void 0 : (_data$eventDetails2 = data.eventDetails) === null || _data$eventDetails2 === void 0 ? void 0 : _data$eventDetails2.toDate), 'dd/MM/yyyy')
        }, {
          title: "EVENTS_FROM_TIME_LABEL",
          value: format(new Date(data === null || data === void 0 ? void 0 : (_data$eventDetails3 = data.eventDetails) === null || _data$eventDetails3 === void 0 ? void 0 : _data$eventDetails3.fromDate), 'hh:mm'),
          skip: true
        }, {
          title: "EVENTS_TO_TIME_LABEL",
          value: format(new Date(data === null || data === void 0 ? void 0 : (_data$eventDetails4 = data.eventDetails) === null || _data$eventDetails4 === void 0 ? void 0 : _data$eventDetails4.toDate), 'hh:mm'),
          skip: true
        }, {
          title: "EVENTS_ADDRESS_LABEL",
          value: data === null || data === void 0 ? void 0 : (_data$eventDetails5 = data.eventDetails) === null || _data$eventDetails5 === void 0 ? void 0 : _data$eventDetails5.address
        }, {
          title: "EVENTS_MAP_LABEL",
          map: true,
          value: data !== null && data !== void 0 && (_data$eventDetails6 = data.eventDetails) !== null && _data$eventDetails6 !== void 0 && _data$eventDetails6.latitude && data !== null && data !== void 0 && (_data$eventDetails7 = data.eventDetails) !== null && _data$eventDetails7 !== void 0 && _data$eventDetails7.longitude ? Digit.Utils.getStaticMapUrl(data === null || data === void 0 ? void 0 : (_data$eventDetails8 = data.eventDetails) === null || _data$eventDetails8 === void 0 ? void 0 : _data$eventDetails8.latitude, data === null || data === void 0 ? void 0 : (_data$eventDetails9 = data.eventDetails) === null || _data$eventDetails9 === void 0 ? void 0 : _data$eventDetails9.longitude) : 'N/A'
        }, {
          title: "EVENTS_ORGANIZER_NAME_LABEL",
          value: data === null || data === void 0 ? void 0 : (_data$eventDetails10 = data.eventDetails) === null || _data$eventDetails10 === void 0 ? void 0 : _data$eventDetails10.organizer
        }, {
          title: "EVENTS_ENTRY_FEE_INR_LABEL",
          value: data === null || data === void 0 ? void 0 : (_data$eventDetails11 = data.eventDetails) === null || _data$eventDetails11 === void 0 ? void 0 : _data$eventDetails11.fees
        }]
      }];
      return {
...
const UICustomizations = {
  AttendanceInboxConfig: {
    preProcess: data => {
      ...
      let selectedOrg = lodash.clone(data.body.inbox.moduleSearchCriteria.orgId ? data.body.inbox.moduleSearchCriteria.orgId : null);
      ...
      let states = lodash.clone(data.body.inbox.moduleSearchCriteria.state ? data.body.inbox.moduleSearchCriteria.state : []);
      let ward = lodash.clone(data.body.inbox.moduleSearchCriteria.ward ? data.body.inbox.moduleSearchCriteria.ward : []);
      delete data.body.inbox.moduleSearchCriteria.state;
      delete data.body.inbox.moduleSearchCriteria.ward;
      states = (_Object$keys = Object.keys(states)) === null || _Object$keys === void 0 ? void 0 : _Object$keys.filter(key => states[key]);
      ward = (_ward = ward) === null || _ward === void 0 ? void 0 : _ward.map(row => row === null || row === void 0 ? void 0 : row.code);
      ...
      const projectType = lodash.clone(data.body.inbox.moduleSearchCriteria.projectType ? data.body.inbox.moduleSearchCriteria.projectType : {});
    ...
    postProcess: (responseArray, uiConfig) => {
      ...
      const statusOptions = responseArray === null || responseArray === void 0 ? void 0 : (_responseArray$status = responseArray.statusMap) === null || _responseArray$status === void 0 ? void 0 : (_responseArray$status2 = _responseArray$status.filter(item => item.applicationstatus)) === null || _responseArray$status2 === void 0 ? void 0 : _responseArray$status2.map(item => ({
      ...
      if ((uiConfig === null || uiConfig === void 0 ? void 0 : uiConfig.type) === "filter") {
        ...
        let fieldConfig = uiConfig === null || uiConfig === void 0 ? void 0 : (_uiConfig$fields = uiConfig.fields) === null || _uiConfig$fields === void 0 ? void 0 : _uiConfig$fields.filter(item => item.type === "dropdown" && item.populators.name === "musterRollStatus");
    ...
    additionalCustomizations: (row, key, column, value, t, searchResult) => {
      ...
      if (key === "ATM_ATTENDANCE_WEEK") {
        const week = `${Digit$2.DateUtils.ConvertTimestampToDate(value === null || value === void 0 ? void 0 : value.startDate, "dd/MM/yyyy")}-${Digit$2.DateUtils.ConvertTimestampToDate(value === null || value === void 0 ? void 0 : value.endDate, "dd/MM/yyyy")}`;
        return /*#__PURE__*/React.createElement("div", null, week);
      }
      if (key === "ATM_NO_OF_INDIVIDUALS") {
        return /*#__PURE__*/React.createElement("div", null, value === null || value === void 0 ? void 0 : value.length);
      }
      if (key === "ATM_AMOUNT_IN_RS") {
        return /*#__PURE__*/React.createElement("span", null, value ? Digit$2.Utils.dss.formatterWithoutRound(value, "number") : t("ES_COMMON_NA"));
      }
      if (key === "ATM_SLA") {
        return parseInt(value) > 0 ? /*#__PURE__*/React.createElement("span", {
      ...
      if (key === "COMMON_WORKFLOW_STATES") {
        return /*#__PURE__*/React.createElement("span", null, t(`WF_MUSTOR_${value}`));
      }
      return /*#__PURE__*/React.createElement("span", null, t(`CASE_NOT_HANDLED`));
    },
    ...
    populateReqCriteria: () => {
      const tenantId = Digit$2.ULBService.getCurrentTenantId();
      return {
  ...
  SearchWageSeekerConfig: {
    ...
    preProcess: data => {
      ...
      let Individual = Object.keys(requestBody).map(key => {
        if (selectConfig[key]) {
        ...
        return key;
      }).filter(key => requestBody[key]).reduce((acc, curr) => {
...
const HRMSCard = () => {
  ...
  const propsForModuleCard = {
    ...
    links: [{
      ...
      link: `/${(_window = window) === null || _window === void 0 ? void 0 : _window.contextPath}/employee/hrms/inbox`
    }, {
      label: t("HR_COMMON_CREATE_EMPLOYEE_HEADER"),
      link: `/${(_window2 = window) === null || _window2 === void 0 ? void 0 : _window2.contextPath}/employee/hrms/create`
    }]
  };
...
const MuktaCard = () => {
  ...
  const propsForModuleCard = {
    Icon: /*#__PURE__*/React.createElement(AttendanceIcon, null),
    moduleName: t("Mukta Customisation Module"),
    kpis: [],
    links: [{
      label: t("Sample"),
      link: `/${(_window = window) === null || _window === void 0 ? void 0 : _window.contextPath}/employee/Mukta/pageone`
    }]
  };
  return /*#__PURE__*/React.createElement(EmployeeModuleCard, propsForModuleCard);
};
...
const SampleComponent = props => {
  ...
  useEffect(() => {
    updateData((props === null || props === void 0 ? void 0 : props.formData) || {});
  }, [props, props === null || props === void 0 ? void 0 : props.formData]);
  return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("h3", null, "View Entered Data(SampleComponent)"), /*#__PURE__*/React.createElement("div", {
    className: "sample-component-style"
  }, Object.keys(data).map(key => {
    return (data === null || data === void 0 ? void 0 : data[key]) && /*#__PURE__*/React.createElement("div", null, key, " : ", JSON.stringify(data === null || data === void 0 ? void 0 : data[key]));
  })));
};
...
const updateCustomConfigs = () => {
  ...
  setupLibraries("Customizations", "commonUiConfig", {
    ...((_window = window) === null || _window === void 0 ? void 0 : (_window$Digit = _window.Digit) === null || _window$Digit === void 0 ? void 0 : (_window$Digit$Customi = _window$Digit.Customizations) === null || _window$Digit$Customi === void 0 ? void 0 : _window$Digit$Customi.commonUiConfig),
    ...UICustomizations
  });
};
const initMuktaCustomisations = () => {
  overrideHooks();
  updateCustomConfigs();
...
export { initMuktaCustomisations };
