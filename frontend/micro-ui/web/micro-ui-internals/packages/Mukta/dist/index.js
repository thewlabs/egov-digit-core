...
var CustomBredcrumb = function CustomBredcrumb(_ref) {
...
var App = function App(_ref2) {
  ...
  var _useTranslation = reactI18next.useTranslation(),
    t = _useTranslation.t;
  return /*#__PURE__*/React__default.createElement(reactRouterDom.Switch, null, /*#__PURE__*/React__default.createElement(React__default.Fragment, null, /*#__PURE__*/React__default.createElement("div", null, /*#__PURE__*/React__default.createElement(CustomBredcrumb, {
    t: t
  }), /*#__PURE__*/React__default.createElement(digitUiReactComponents.PrivateRoute, {
    path: path + "/pageone",
    component: function component() {
      return /*#__PURE__*/React__default.createElement(digitUiReactComponents.Card, null, /*#__PURE__*/React__default.createElement("div", null, "Sample screen created in Mukta Customisation folder"));
    }
  }))));
};
...
var useEventDetails = function useEventDetails(tenantId, filters, config) {
  if (config === void 0) {
    config = {};
  }
  return reactQuery.useQuery(['EVENT_DETAILS', tenantId, filters], function () {
    return Digit.EventsServices.EventDetails(tenantId, filters);
  }, _extends({
...
var contracts = {};
var events = {
  useEventDetails: useEventDetails
};
var Hooks = {
  attendance: {
...
var HRMSCard = function HRMSCard() {
  ...
  var propsForModuleCard = {
    Icon: /*#__PURE__*/React__default.createElement(digitUiReactComponents.HRIcon, null),
...
var MuktaCard = function MuktaCard() {
  var _window;
  var _useTranslation = reactI18next.useTranslation(),
    t = _useTranslation.t;
  var propsForModuleCard = {
    Icon: /*#__PURE__*/React__default.createElement(digitUiReactComponents.AttendanceIcon, null),
...
var SampleComponent = function SampleComponent(props) {
  ...
  return /*#__PURE__*/React__default.createElement("div", null, /*#__PURE__*/React__default.createElement("h3", null, "View Entered Data(SampleComponent)"), /*#__PURE__*/React__default.createElement("div", {
    className: "sample-component-style"
  }, Object.keys(data).map(function (key) {
    return (data === null || data === void 0 ? void 0 : data[key]) && /*#__PURE__*/React__default.createElement("div", null, key, " : ", JSON.stringify(data === null || data === void 0 ? void 0 : data[key]));
  })));
};

var MuktaModule = function MuktaModule(_ref) {
  var stateCode = _ref.stateCode;
  stateCode = Digit.ULBService.getStateId();
  var moduleCode = ["Mukta"];
...
var setupHooks = function setupHooks(HookName, HookFunction, method) {
...
var initMuktaCustomisations = function initMuktaCustomisations() {
  overrideHooks();
  updateCustomConfigs();
...
exports.initMuktaCustomisations = initMuktaCustomisations;
