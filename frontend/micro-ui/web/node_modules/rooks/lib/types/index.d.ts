...
import { MutableRefObject, RefObject, useEffect, Ref, Dispatch, SetStateAction } from 'react';
 ...
 */
declare function useBoundingclientrectRef(): [CallbackRef | null, ClientRect | DOMRect | null, () => void];
...
declare type OnChangeEventCallback = (this: Document, ev: any, isOpen: boolean) => any;
 ...
 */
declare function useInput(initialValue?: any, opts?: Options): InputHandler;
 ...
 */
declare function useIntervalWhen(cb: () => void, intervalDurationMs?: number, when?: boolean): void;
 ...
 * @return callbackRef
 */
declare function useKeyRef(input: string | number | Array<string | number>, callback: (e: KeyboardEvent) => any, opts?: Options$1): CallbackRef;
 ...
 * @param {Options} options
 */
declare function useKey(input: string | number | Array<string | number>, callback: (e: KeyboardEvent) => any, opts?: Options$2): void;
 ...
 * @param opts
 */
declare function useKeys(keysList: string[], callback: (e: KeyboardEvent) => any, opts?: Options$3): void;
 ...
 * @param refs
 */
declare function useMergeRefs(...refs: AnyRef[]): (CallbackRef) | null;
...
declare function useMultiSelectableList<T>(list?: T[], initialSelectIndices?: number[], allowUnselected?: boolean): [
    (number[] | T[])[],
    {
        toggleSelection: ({ index: number, value: T }: {
            index: any;
            value: any;
        }) => () => void;
        matchSelection: ({ index: number, value: T }: {
            index: any;
            value: any;
        }) => void;
        updateSelections: ({ indices, values }: {
            indices: number[];
            values: T[];
        }) => () => void;
    }
...
declare function useSelectableList<T>(list?: T[], initialIndex?: number, allowUnselected?: boolean): [
    (number | T)[],
    {
        updateSelection: ({ index: number, value: T }: {
            index: any;
            value: any;
        }) => () => void;
        toggleSelection: ({ index: number, value: T }: {
...
interface StorageHandlerAsObject$1 {
    value: any;
    set: (newValue: any) => void;
    remove: () => void;
}
interface StorageHandlerAsArray$1 extends Array<any> {
    0: any;
    1: (newValue: any) => void;
    2: () => void;
}
interface StorageHandler$1 extends StorageHandlerAsArray$1 {
}
interface StorageHandler$1 extends StorageHandlerAsObject$1 {
}
/**
 * useSessionstorage
 ...
 * @param argOpts
 */
declare function useTimeAgo(input: any, argOpts: Options$4): string;
 ...
 */
declare const useUndoState: (defaultValue: any, options?: UndoStateOptions | undefined) => [any, (prevState: any) => any, () => void];
 ...
 * @return {undefined}
 */
declare function useUpdateEffect(callback: () => any, conditions?: Array<any>): void;
 ...
 * @param opts Options
 */
declare function useVisibilitySensor(ref: any, opts: any): any;
 ...
 * @return {Worker}
 */
declare function useWorker(scriptPath: string, workerOptions?: WorkerOptions, attributes?: Object): Worker | undefined;
